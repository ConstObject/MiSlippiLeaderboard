module.exports = {
  ...
  title: 'Michigan Ranked Slippi Leaderboard',
  ...
  repoPath: 'https://constobject.github.io/MiSlippiLeaderboard/',

  // Google sheets ID for player connect codes.
  // https://docs.google.com/spreadsheets/d/[YOUR ID]
  spreadsheetID: '1XSu6tnD77L_gldaI5Ux-I8bD1Z08ANNOjiCHXhZmFtA',
};
